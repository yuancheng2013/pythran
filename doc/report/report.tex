...
autour du compilateur \Pythran{}. Les objectifs sont~:
  ...
  \todo[inline]{manque une annonce du plan ici}
...
Comme \Pythran{}\todo{référence bibliographique} est un logiciel \emph{Open Source}, pour que tous le monde
...
La source du projet est contrôlée par Git\todo{référence bibliographique ici ?}, un outil de gestion de version
...
Les développeurs discutent quotidiennement sur IRC\todo{acronym ?}, et utilisent une liste de diffusion spécifique.
...
\emph{euler}\todo{expliquer un peu ce qu'est le projet euler} qui existe déjà dans le projet \Pythran{}. Il a permis de trouver plusieurs
...
\todo[inline]{ça c'est le Bilan OUTIL}
...
\todo[inline]{et le Bilan Ingénieur}

\todo[inline]{manque le Bilan Humain}
...
\todo[inline]{Mon encadrant est vraiment très gentil, il a relu avec étonnement mon rapport d'étonnement}
